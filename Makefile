...
SOURCES=utils.c my_math.c math_main.c log.c acgtn.c pileup.c input_data.c output_data.c my_string.c txt.c ucsc_refgene.c ucsc_main.c txt_main.c bedtools.c bedtools_main.c snpeff.c fasta.c fasta_main.c vcf.c vcf_main.c my_tabix.c tabix_main.c fastq.c fastq_main.c main.c 
